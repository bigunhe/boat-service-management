  ...
  const fetchSalesVisitAnalytics = async () => {
    ...
    try {
      ...
      const [
        ...
        fetch(`${baseUrl}/api/analytics/sales-visits/trends?period=${selectedPeriod}`, { headers }),
        fetch(`${baseUrl}/api/analytics/sales-visits/category-distribution`, { headers }),
        fetch(`${baseUrl}/api/analytics/sales-visits/geographic-distribution`, { headers }),
        fetch(`${baseUrl}/api/analytics/sales-visits/peak-hours`, { headers }),
        fetch(`${baseUrl}/api/analytics/sales-visits/conversion-rates`, { headers }),
        fetch(`${baseUrl}/api/analytics/sales-visits/status-analytics`, { headers })
      ]);
