  ...
  const fetchInventoryAnalytics = async () => {
    ...
    try {
      ...
      const [
        ...
        fetch(`${baseUrl}/api/analytics/spare-parts/inventory-overview`, { headers }),
        fetch(`${baseUrl}/api/analytics/spare-parts/category-analytics`, { headers }),
        fetch(`${baseUrl}/api/analytics/spare-parts/company-analytics`, { headers }),
        fetch(`${baseUrl}/api/analytics/spare-parts/stock-alerts`, { headers }),
        fetch(`${baseUrl}/api/analytics/spare-parts/time-analytics?period=${selectedPeriod}`, { headers }),
        fetch(`${baseUrl}/api/analytics/spare-parts/usage-analytics?period=${selectedPeriod}`, { headers })
      ]);
